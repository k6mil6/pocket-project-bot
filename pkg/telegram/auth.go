...
func (b *Bot) initAuthorisationProcess(message *tgbotapi.Message) error {
	authLink, err := b.generateAuthorisationLink(message.Chat.ID)
	if err != nil {
		return err
	}
...
func (b *Bot) generateAuthorisationLink(chatID int64) (string, error) {
